(function ($) {
  ...
  var serialize = function (data, accuracy) {
    accuracy = accuracy > 0 ? accuracy : 2;
  ...
  // Simplified Chinese
  Scheduler.LOCALES['en-fr'] = Scheduler.LOCALES.fr = {
    AM: 'Matin',
    PM: 'Apr&egrave;s-midi',
    TIME_TITLE: 'HEURE',
    WEEK_TITLE: 'JOUR',
    WEEK_DAYS: ['LUNDI', 'MARDI', 'MERCREDI', 'JEUDI', 'VENDREDI', 'SAMEDI', 'DIMANCHE'],
    DRAG_TIP: "Cliquer pour selectionner l'heure",
